	...
	<div class="content">
		...
		<form method="POST" action="registerprocess.php">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="First Name" name="fname" required/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Middle Name" name="mname" required/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Last Name" name="lname" required/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Phone number" name="contact_num" required/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label visible-ie8 visible-ie9">Userame</label>
				<div class="controls">
					<div class="input-icon left">
			...
			<div class="form-actions">
				...
				?>
				<button type="button" id="back-btn" class="btn" href="login.php">
				 <a href="login.php" style="text-decoration:none;"><i class="m-icon-swapleft" href="login.php"></i> Back
				</a>
				<?php
					}
				?>
