    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-fire"></i> Latest movie</a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-play"></i> Top views</a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-star"></i> Top ratings</a>
                    </li>
