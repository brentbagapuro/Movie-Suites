...
<body>
                         ...
                         ?>
                            <label>Amount Due:</label>
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" class="form-control" id="amount" value=<?php echo $amount; ?> style="text-align:right;" disabled>
                                    <span class="input-group-addon">.00</span>
                                </div> 
                            <label>Cash:</label> 
                                <div class="form-group input-group">
                                    <span class="input-group-addon">₱</span>
                                    <input type="text" class="form-control" id="cash" style="text-align:right;" value="">
                                    <span class="input-group-addon">.00</span>
                                </div> 
                            <label>Change:</label> 
                                <div class="form-group input-group">
    ...
    <script>
        ...
        function checkField()
        {
            ...
            {
                $("#pay").attr("href", "receipt.php?c="+res+"&m="+money);
            }
        }
    </script>
