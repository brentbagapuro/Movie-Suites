                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h2>Register employee</h2>
                            <form role="form" action="adduserprocess.php" method="post">
                                ...
                                <b style="font-size: 15px;">Position: </b>
                                 <div class="form-group">
                                   
                                    <select id="position" class="form-control" name="position" id="position" style="width:270px;">
                                        <option>Receptionist</option>
                                        <option>Admin</option>
                                    </select>
                                </div>

                                <button type="button" class="btn btn-primary" name="btnsubmit" id="btnsubmit"  data-toggle="modal" data-target="#confirm-add">Add user</button>
                                <button type="button" class="btn btn-primary" name="btnsubmit2" id="btnsubmit2" data-toggle="modal" data-target="#confirm-update" disabled>Update user</button>
                                <button type="button" class="btn btn-primary" name="btnsubmit3" id="btnsubmit3" data-toggle="modal" data-target="#confirm-delete" disabled>Delete user</button>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              You are about to add this user.
                                              <br>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                         ...
                         if(isset($_POST['search1']))
                         {
                           ...
                           if($filter=="Firstname")
                           {
                              $qry = "SELECT * FROM tblemployee WHERE fname LIKE '%$search%'";
                              $result=$con->query($qry);
                    ...
                    ?>
                                ...
                                <tr>
                                   <td style="font-size:13px;"><?php echo $emp_id; ?></td>
                                   <td style="font-size:13px;" ><?php echo $fname . " " . $mname . " " . $lname; ?></td>
                                   <td style="font-size:13px;" > <?php echo $position; ?></td>
                    ...
                    <?php
                           ...
                           {
                            $qry = "SELECT * FROM tblemployee WHERE mname LIKE '%$search%'";
                            $result=$con->query($qry);
                              if(mysqli_num_rows($result) > 0)
                              {
                                while($row=$result->fetch_array())
                    ...
                    <?php
                            ...
                            if($filter=="Lastname")
                           {
                           $qry = "SELECT * FROM tblemployee WHERE lname LIKE '%$search%'";
                           $result=$con->query($qry);
                              if(mysqli_num_rows($result) > 0)
                              {
                                while($row=$result->fetch_array())
                    ...
                    ?>
                          ...
                          <tr>
                                   ...
                                   <?php
                                    if($status == "BLOCKED" )
                                    { ?>
                                        <td bgcolor="red" style="font-size:13px;"><?php echo $emp_id; ?></td>
