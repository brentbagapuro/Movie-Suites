...
.disp
{
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="register.php?index=i" > REGISTER
                        <i class="fa fa-fw fa-sign-in"></i></a>
                    </li>
                </ul>
 ...
 <!-- Page Content -->
    <div class="container"><br>
        ...
        <a href="index.php"><button class="dropbtn" id="ref" name="ref">Refresh</button></a>
        <form  method="POST" action="#">
        ...
        ?>
                <div class="disp">  
                    <a href="movie_info1.php?id=<?php echo $id;?>">
        ...
        <?php 
            ...
            else if(isset($_POST['btnsubmit2']))
            {
                ...
                {
                    $result = mysql_query("SELECT * FROM tblmovie WHERE artist LIKE '%$txt2%' ORDER BY title DESC");
                    while($row=$result->fetch_array())
                    {
                        $id = $row['movie_id'];
                        $title = $row['title'];
                ...
                {
                    $result = mysql_query("SELECT * FROM tblmovie WHERE director LIKE '%$txt2%' ORDER BY title DESC");
                ...
                {
                    ?>
                        <center><h1 style="color: white;">No matches found</h1></center>
                    <?php
                }
            }
            else
        ...
        ?>
                ...
                <div class="disp">  
                    <a href="movie_info1.php?id=<?php echo $id;?>">
                        <img class="img-responsive" src="<?php echo $img; ?>" width="150" height="180">
                    </a><br>
                </div>
